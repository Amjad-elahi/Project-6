    ...
    return AlertDialog(
      ...
      actions: [
        ElevatedButton(
            style: ButtonStyle(
                foregroundColor: WidgetStatePropertyAll(
                    isYesChange ? const Color(0xffFFFFFF) : const Color(0xffB98875)),
                minimumSize: const WidgetStatePropertyAll(Size(130, 50)),
        ...
        ElevatedButton(
            style: ButtonStyle(
                foregroundColor: WidgetStatePropertyAll(
                    isNoChange ? const Color(0xffFFFFFF) : const Color(0xffB98875)),
                minimumSize: const WidgetStatePropertyAll(Size(130, 50)),
                shape: const WidgetStatePropertyAll(RoundedRectangleBorder(
                    side: BorderSide(width: 2, color: Color(0xffB98875)),
                    borderRadius: BorderRadius.all(Radius.circular(24)))),
